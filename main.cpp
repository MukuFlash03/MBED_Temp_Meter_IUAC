...
//SerialRPCInterface pcr(p9, p10); 
//Serial        pcr(p9, p10);  
//Serial        pcr(USBTX, USBRX);  
SerialRPCInterface pcr(USBTX, USBRX);  //joby
...
RPCVariable<float> rpcjoby(&joby,"joby");       // joby
        ...
        {   
            ...
            switch (input)
            {
                ...
                case 10:
                    ...
                    if (togglecounter>=3) //togglecounter == 3
                        togglecounter=0;
...
{   
   ...
   // tout.attach(&timeoutNoIP, 10.0);//joby
            ...
            switch (input)
            {
               ...
               case 4:
                ...
                case 10: 
                    ...
                    if (togglecounter>=8) //togglecounter == 8
                        togglecounter=0;
...
{ 
 ...
 //tout.attach(&continuousreadsensor, 1.0);
  ...
  {  
    ...
    while (1) 
    {
       ...
       //display20x4temperature() ;
        for (int junk= 0; junk < 50000000; junk++);
        //__wfi();
